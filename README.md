...
,
    ...
    try:
        # Create audit log
        api_response = api_instance.shield_service_create_organization_audit_logs(org_idbody)
        pprint(api_response)
...
------------ | ------------- | ------------- | -------------
*AuditLogApi* | [**shield_service_create_organization_audit_logs**](docs/apis/tags/AuditLogApi.md#shield_service_create_organization_audit_logs) | **post** /v1beta1/organization/{orgId}/auditlogs | Create audit log
*AuditLogApi* | [**shield_service_get_organization_audit_log**](docs/apis/tags/AuditLogApi.md#shield_service_get_organization_audit_log) | **get** /v1beta1/organization/{orgId}/auditlogs/{id} | Get audit log
*AuditLogApi* | [**shield_service_list_organization_audit_logs**](docs/apis/tags/AuditLogApi.md#shield_service_list_organization_audit_logs) | **get** /v1beta1/organization/{orgId}/auditlogs | List audit logs
...
*AuthnApi* | [**shield_service_auth_token**](docs/apis/tags/AuthnApi.md#shield_service_auth_token) | **post** /v1beta1/auth/token | Generate access token by given credentials
...
*GroupApi* | [**shield_service_get_group**](docs/apis/tags/GroupApi.md#shield_service_get_group) | **get** /v1beta1/organizations/{orgId}/groups/{id} | Get group
...
*GroupApi* | [**shield_service_update_group**](docs/apis/tags/GroupApi.md#shield_service_update_group) | **put** /v1beta1/organizations/{orgId}/groups/{id} | Update group
...
*NamespaceApi* | [**shield_service_get_namespace**](docs/apis/tags/NamespaceApi.md#shield_service_get_namespace) | **get** /v1beta1/namespaces/{id} | Get namespace
...
*OrganizationApi* | [**shield_service_list_organization_service_users**](docs/apis/tags/OrganizationApi.md#shield_service_list_organization_service_users) | **get** /v1beta1/organizations/{id}/serviceusers | List organization service users
...
*PermissionApi* | [**shield_service_get_permission**](docs/apis/tags/PermissionApi.md#shield_service_get_permission) | **get** /v1beta1/permissions/{id} | Get permission
...
*PolicyApi* | [**shield_service_get_policy**](docs/apis/tags/PolicyApi.md#shield_service_get_policy) | **get** /v1beta1/policies/{id} | Get policy
*PolicyApi* | [**shield_service_update_policy**](docs/apis/tags/PolicyApi.md#shield_service_update_policy) | **put** /v1beta1/policies/{id} | Update policy
...
*RelationApi* | [**shield_service_delete_relation**](docs/apis/tags/RelationApi.md#shield_service_delete_relation) | **delete** /v1beta1/relations/{relation}/object/{object}/subject/{subject} | Delete relation
*RelationApi* | [**shield_service_get_relation**](docs/apis/tags/RelationApi.md#shield_service_get_relation) | **get** /v1beta1/relations/{id} | Get relation
...
*ResourceApi* | [**shield_service_delete_project_resource**](docs/apis/tags/ResourceApi.md#shield_service_delete_project_resource) | **delete** /v1beta1/projects/{projectId}/resources/{id} | Delete resource
*ResourceApi* | [**shield_service_get_project_resource**](docs/apis/tags/ResourceApi.md#shield_service_get_project_resource) | **get** /v1beta1/projects/{projectId}/resources/{id} | Get resource
...
*ResourceApi* | [**shield_service_update_project_resource**](docs/apis/tags/ResourceApi.md#shield_service_update_project_resource) | **put** /v1beta1/projects/{projectId}/resources/{id} | Update resource
...
*RoleApi* | [**shield_service_list_roles**](docs/apis/tags/RoleApi.md#shield_service_list_roles) | **get** /v1beta1/roles | List platform roles
...
*ServiceUserApi* | [**shield_service_create_service_user_key**](docs/apis/tags/ServiceUserApi.md#shield_service_create_service_user_key) | **post** /v1beta1/serviceusers/{id}/keys | Create service user key
*ServiceUserApi* | [**shield_service_create_service_user_secret**](docs/apis/tags/ServiceUserApi.md#shield_service_create_service_user_secret) | **post** /v1beta1/serviceusers/{id}/secrets | Create service user secret
*ServiceUserApi* | [**shield_service_delete_service_user**](docs/apis/tags/ServiceUserApi.md#shield_service_delete_service_user) | **delete** /v1beta1/serviceusers/{id} | Delete service user
*ServiceUserApi* | [**shield_service_delete_service_user_key**](docs/apis/tags/ServiceUserApi.md#shield_service_delete_service_user_key) | **delete** /v1beta1/serviceusers/{id}/keys/{keyId} | Delete service user key
*ServiceUserApi* | [**shield_service_delete_service_user_secret**](docs/apis/tags/ServiceUserApi.md#shield_service_delete_service_user_secret) | **delete** /v1beta1/serviceusers/{id}/secrets/{secretId} | Delete service user secret
*ServiceUserApi* | [**shield_service_get_service_user**](docs/apis/tags/ServiceUserApi.md#shield_service_get_service_user) | **get** /v1beta1/serviceusers/{id} | Get service user
*ServiceUserApi* | [**shield_service_get_service_user_key**](docs/apis/tags/ServiceUserApi.md#shield_service_get_service_user_key) | **get** /v1beta1/serviceusers/{id}/keys/{keyId} | Get service user key
...
*ServiceUserApi* | [**shield_service_list_service_users**](docs/apis/tags/ServiceUserApi.md#shield_service_list_service_users) | **get** /v1beta1/serviceusers | List org service users
...
*UserApi* | [**shield_service_get_organizations_by_user**](docs/apis/tags/UserApi.md#shield_service_get_organizations_by_user) | **get** /v1beta1/users/{id}/organizations | Get user organizations
*UserApi* | [**shield_service_get_projects_by_current_user**](docs/apis/tags/UserApi.md#shield_service_get_projects_by_current_user) | **get** /v1beta1/users/self/projects | Get my projects
*UserApi* | [**shield_service_get_projects_by_user**](docs/apis/tags/UserApi.md#shield_service_get_projects_by_user) | **get** /v1beta1/users/{id}/projects | Get user projects
*UserApi* | [**shield_service_get_user**](docs/apis/tags/UserApi.md#shield_service_get_user) | **get** /v1beta1/users/{id} | Get user
...
*UserApi* | [**shield_service_list_user_groups**](docs/apis/tags/UserApi.md#shield_service_list_user_groups) | **get** /v1beta1/users/{id}/groups | List user groups
...
*UserApi* | [**shield_service_update_user**](docs/apis/tags/UserApi.md#shield_service_update_user) | **put** /v1beta1/users/{id} | Update user
...
If the OpenAPI document is large, imports in shield_api.apis and shield_api.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from shield_api.apis.default_api import DefaultApi`
...
import shield_api
from shield_api.apis import *
from shield_api.models import *
```
