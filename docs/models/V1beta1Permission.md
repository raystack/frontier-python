# frontier_api.model.v1beta1_permission.V1beta1Permission
...
**createdAt** | str, datetime,  | str,  | The time the permission was created. | [optional] value must conform to RFC-3339 date-time
