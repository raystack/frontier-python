...
class V1beta1AuthStrategy(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "params", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "params", ], str]):
