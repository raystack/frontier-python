...
class V1beta1BatchCheckPermissionBody(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["permission", "resource", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["permission", "resource", ], str]):
