...
class V1beta1CreatePermissionResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class permissions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1beta1Permission']:
                        return V1beta1Permission
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V1beta1Permission'], typing.List['V1beta1Permission']],
                ...
                def __getitem__(self, i: int) -> 'V1beta1Permission':
