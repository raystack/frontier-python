...
class V1beta1Domain(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "orgId", "token", "state", "createdAt", "updatedAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "orgId", "token", "state", "createdAt", "updatedAt", ], str]):
