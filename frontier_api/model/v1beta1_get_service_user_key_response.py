...
class V1beta1GetServiceUserKeyResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class keys(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1beta1JSONWebKey']:
                        return V1beta1JSONWebKey
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V1beta1JSONWebKey'], typing.List['V1beta1JSONWebKey']],
                ...
                def __getitem__(self, i: int) -> 'V1beta1JSONWebKey':
