...
class V1beta1ListNamespacesResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class namespaces(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1beta1Namespace']:
                        return V1beta1Namespace
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V1beta1Namespace'], typing.List['V1beta1Namespace']],
                ...
                def __getitem__(self, i: int) -> 'V1beta1Namespace':
