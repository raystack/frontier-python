...
class V1beta1ListOrganizationDomainsResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class domains(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1beta1Domain']:
                        return V1beta1Domain
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V1beta1Domain'], typing.List['V1beta1Domain']],
                ...
                def __getitem__(self, i: int) -> 'V1beta1Domain':
