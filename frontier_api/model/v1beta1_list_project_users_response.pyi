...
class V1beta1ListProjectUsersResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class rolePairs(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1beta1ListProjectUsersResponseRolePair']:
                        return V1beta1ListProjectUsersResponseRolePair
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V1beta1ListProjectUsersResponseRolePair'], typing.List['V1beta1ListProjectUsersResponseRolePair']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'rolePairs':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'V1beta1ListProjectUsersResponseRolePair':
                    return super().__getitem__(i)
            __annotations__ = {
                "users": users,
                "rolePairs": rolePairs,
