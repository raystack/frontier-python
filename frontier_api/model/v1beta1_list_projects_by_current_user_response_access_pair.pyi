...
class V1beta1ListProjectsByCurrentUserResponseAccessPair(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["projectId", "permissions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["projectId", "permissions", ], str]):
