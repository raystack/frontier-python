...
class V1beta1ListServiceUserKeysResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class keys(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['V1beta1ServiceUserKey']:
                        return V1beta1ServiceUserKey
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V1beta1ServiceUserKey'], typing.List['V1beta1ServiceUserKey']],
                ...
                def __getitem__(self, i: int) -> 'V1beta1ServiceUserKey':
