...
class V1beta1ListServiceUserSecretsResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class secrets(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['V1beta1SecretCredential'], typing.List['V1beta1SecretCredential']],
                ...
                def __getitem__(self, i: int) -> 'V1beta1SecretCredential':
