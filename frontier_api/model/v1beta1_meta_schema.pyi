...
class V1beta1MetaSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "schema", "createdAt", "updatedAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "schema", "createdAt", "updatedAt", ], str]):
