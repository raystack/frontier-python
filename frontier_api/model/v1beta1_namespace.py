...
class V1beta1Namespace(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "metadata", "createdAt", "updatedAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "metadata", "createdAt", "updatedAt", ], str]):
