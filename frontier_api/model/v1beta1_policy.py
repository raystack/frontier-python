...
class V1beta1Policy(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "title", "createdAt", "updatedAt", "roleId", "resource", "principal", "metadata", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "title", "createdAt", "updatedAt", "roleId", "resource", "principal", "metadata", ], str]):
