...
class V1beta1Preference(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "value", "resourceId", "resourceType", "createdAt", "updatedAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "value", "resourceId", "resourceType", "createdAt", "updatedAt", ], str]):
