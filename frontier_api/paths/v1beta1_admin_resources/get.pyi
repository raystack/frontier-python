...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'organizationId': typing.Union[OrganizationIdSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = V1beta1ListResourcesResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_service_list_resources_oapg(
        self,
...
class AdminServiceListResources(BaseApi):
    ...
    def admin_service_list_resources(
        ...
        return self._admin_service_list_resources_oapg(
