...
class BaseApi(api_client.Api):
    @typing.overload
    def _frontier_service_list_organization_audit_logs_oapg(
        self,
...
class FrontierServiceListOrganizationAuditLogs(BaseApi):
    ...
    def frontier_service_list_organization_audit_logs(
        ...
        return self._frontier_service_list_organization_audit_logs_oapg(
