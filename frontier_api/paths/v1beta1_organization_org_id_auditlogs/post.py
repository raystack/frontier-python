...
class BaseApi(api_client.Api):
    @typing.overload
    def _frontier_service_create_organization_audit_logs_oapg(
        self,
...
class FrontierServiceCreateOrganizationAuditLogs(BaseApi):
    ...
    def frontier_service_create_organization_audit_logs(
        ...
        return self._frontier_service_create_organization_audit_logs_oapg(
            body=body,
