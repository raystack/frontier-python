...
class BaseApi(api_client.Api):
    @typing.overload
    def _frontier_service_create_organization_invitation_oapg(
        self,
...
class FrontierServiceCreateOrganizationInvitation(BaseApi):
    ...
    def frontier_service_create_organization_invitation(
        ...
        return self._frontier_service_create_organization_invitation_oapg(
            body=body,
