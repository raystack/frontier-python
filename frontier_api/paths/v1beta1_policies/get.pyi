...
SchemaFor200ResponseBodyApplicationJson = V1beta1ListPoliciesResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_service_list_policies_oapg(
        self,
...
class AdminServiceListPolicies(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def admin_service_list_policies(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def admin_service_list_policies(
        ...
        return self._admin_service_list_policies_oapg(
