...
from shield_api.paths.v1beta1_check.post import ShieldServiceCheckResourcePermission
from shield_api.paths.v1beta1_auth_jwks.get import ShieldServiceGetJwks
from shield_api.paths.well_known_jwks_json.get import ShieldServiceGetJwks2


class AuthzApi(
    ShieldServiceCheckResourcePermission,
    ShieldServiceGetJwks,
    ShieldServiceGetJwks2,
):
