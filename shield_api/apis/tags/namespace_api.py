...
from shield_api.paths.v1beta1_namespaces_id.get import ShieldServiceGetNamespace
from shield_api.paths.v1beta1_namespaces.get import ShieldServiceListNamespaces


class NamespaceApi(
    ShieldServiceGetNamespace,
    ShieldServiceListNamespaces,
):
