...
from shield_api.paths.v1beta1_admin_relations.get import AdminServiceListRelations
from shield_api.paths.v1beta1_relations.post import ShieldServiceCreateRelation
from shield_api.paths.v1beta1_relations_relation_object_object_subject_subject.delete import ShieldServiceDeleteRelation
from shield_api.paths.v1beta1_relations_id.get import ShieldServiceGetRelation


class RelationApi(
    AdminServiceListRelations,
    ShieldServiceCreateRelation,
    ShieldServiceDeleteRelation,
    ShieldServiceGetRelation,
):
