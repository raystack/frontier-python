...
class V1beta1AuthTokenRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["grantType", "clientId", "clientSecret", "assertion", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["grantType", "clientId", "clientSecret", "assertion", ], str]):
