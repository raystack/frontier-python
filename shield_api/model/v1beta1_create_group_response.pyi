...
class V1beta1CreateGroupResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def group() -> typing.Type['V1beta1Group']:
                return V1beta1Group
            __annotations__ = {
                "group": group,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["group"]) -> 'V1beta1Group': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["group"]) -> typing.Union['V1beta1Group', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        group: typing.Union['V1beta1Group', schemas.Unset] = schemas.unset,
