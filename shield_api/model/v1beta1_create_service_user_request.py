...
class V1beta1CreateServiceUserRequest(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def body() -> typing.Type['V1beta1ServiceUserRequestBody']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["body"]) -> 'V1beta1ServiceUserRequestBody': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["orgId", "body", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["body"]) -> typing.Union['V1beta1ServiceUserRequestBody', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["orgId", "body", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        body: typing.Union['V1beta1ServiceUserRequestBody', schemas.Unset] = schemas.unset,
