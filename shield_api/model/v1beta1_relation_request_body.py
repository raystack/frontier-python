...
class V1beta1RelationRequestBody(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["object", "subject", "relation", "subjectSubRelation", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["object", "subject", "relation", "subjectSubRelation", ], str]):
