...
PageNumSchema = schemas.Int32Schema
...
class BaseApi(api_client.Api):
    @typing.overload
    def _admin_service_list_all_users_oapg(
        self,
...
class AdminServiceListAllUsers(BaseApi):
    ...
    def admin_service_list_all_users(
        ...
        return self._admin_service_list_all_users_oapg(
