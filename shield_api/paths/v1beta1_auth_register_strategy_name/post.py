...
# Path params
StrategyNameSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'strategyName': typing.Union[StrategyNameSchema, str, ],
    }
)
...
request_path_strategy_name = api_client.PathParameter(
    name="strategyName",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _shield_service_authenticate2_oapg(
        self,
...
class ShieldServiceAuthenticate2(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def shield_service_authenticate2(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def shield_service_authenticate2(
        ...
        return self._shield_service_authenticate2_oapg(
