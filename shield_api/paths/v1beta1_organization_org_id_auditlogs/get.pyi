...
SchemaFor200ResponseBodyApplicationJson = V1beta1ListOrganizationAuditLogsResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _shield_service_list_organization_audit_logs_oapg(
        self,
...
class ShieldServiceListOrganizationAuditLogs(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def shield_service_list_organization_audit_logs(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def shield_service_list_organization_audit_logs(
        ...
        return self._shield_service_list_organization_audit_logs_oapg(
