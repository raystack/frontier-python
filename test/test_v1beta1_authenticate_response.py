...
class TestV1beta1AuthenticateResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1AuthenticateResponse:
        """Test V1beta1AuthenticateResponse
        ...
        if include_optional:
            return V1beta1AuthenticateResponse(
                endpoint = '',
                state = '',
                state_options = frontier_api.models.state_options_has_additional_configurations_for_the_authentication_flow_at_hand.state_options has additional configurations for the authentication flow at hand()
            )
        else:
            return V1beta1AuthenticateResponse(
        )
    ...
    def testV1beta1AuthenticateResponse(self):
        """Test V1beta1AuthenticateResponse"""
