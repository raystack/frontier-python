...
class TestV1beta1BatchCheckPermissionRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1BatchCheckPermissionRequest:
        """Test V1beta1BatchCheckPermissionRequest
        ...
        if include_optional:
            return V1beta1BatchCheckPermissionRequest(
                bodies = [
                    frontier_api.models.v1beta1_batch_check_permission_body.v1beta1BatchCheckPermissionBody(
                        permission = '', 
                        resource = '', )
                    ]
            )
    ...
    def testV1beta1BatchCheckPermissionRequest(self):
        """Test V1beta1BatchCheckPermissionRequest"""
