...
class TestV1beta1CheckoutSubscriptionBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1CheckoutSubscriptionBody:
        """Test V1beta1CheckoutSubscriptionBody
    ...
    def testV1beta1CheckoutSubscriptionBody(self):
        """Test V1beta1CheckoutSubscriptionBody"""
