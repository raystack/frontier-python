...
class TestV1beta1CreateBillingAccountResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1CreateBillingAccountResponse:
        """Test V1beta1CreateBillingAccountResponse
    ...
    def testV1beta1CreateBillingAccountResponse(self):
        """Test V1beta1CreateBillingAccountResponse"""
