...
class TestV1beta1CreateMetaSchemaResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1CreateMetaSchemaResponse:
        """Test V1beta1CreateMetaSchemaResponse
    ...
    def testV1beta1CreateMetaSchemaResponse(self):
        """Test V1beta1CreateMetaSchemaResponse"""
