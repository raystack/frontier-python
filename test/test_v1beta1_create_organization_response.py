...
class TestV1beta1CreateOrganizationResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1CreateOrganizationResponse:
        """Test V1beta1CreateOrganizationResponse
    ...
    def testV1beta1CreateOrganizationResponse(self):
        """Test V1beta1CreateOrganizationResponse"""
