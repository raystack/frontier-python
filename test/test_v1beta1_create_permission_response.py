...
class TestV1beta1CreatePermissionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1CreatePermissionResponse:
        """Test V1beta1CreatePermissionResponse
        ...
        if include_optional:
            return V1beta1CreatePermissionResponse(
                permissions = [
                    frontier_api.models.v1beta1_permission.v1beta1Permission(
                        id = '', 
                        name = '', 
                        title = '', 
    ...
    def testV1beta1CreatePermissionResponse(self):
        """Test V1beta1CreatePermissionResponse"""
