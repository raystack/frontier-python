...
class TestV1beta1CreatePreferencesRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1CreatePreferencesRequest:
        """Test V1beta1CreatePreferencesRequest
    ...
    def testV1beta1CreatePreferencesRequest(self):
        """Test V1beta1CreatePreferencesRequest"""
