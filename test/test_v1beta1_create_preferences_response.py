...
class TestV1beta1CreatePreferencesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1CreatePreferencesResponse:
        """Test V1beta1CreatePreferencesResponse
    ...
    def testV1beta1CreatePreferencesResponse(self):
        """Test V1beta1CreatePreferencesResponse"""
