...
class TestV1beta1GetBillingAccountResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1GetBillingAccountResponse:
        """Test V1beta1GetBillingAccountResponse
    ...
    def testV1beta1GetBillingAccountResponse(self):
        """Test V1beta1GetBillingAccountResponse"""
