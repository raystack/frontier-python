...
class TestV1beta1GetBillingBalanceResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1GetBillingBalanceResponse:
        """Test V1beta1GetBillingBalanceResponse
    ...
    def testV1beta1GetBillingBalanceResponse(self):
        """Test V1beta1GetBillingBalanceResponse"""
