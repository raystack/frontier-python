...
class TestV1beta1GetOrganizationRoleResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1GetOrganizationRoleResponse:
        """Test V1beta1GetOrganizationRoleResponse
    ...
    def testV1beta1GetOrganizationRoleResponse(self):
        """Test V1beta1GetOrganizationRoleResponse"""
