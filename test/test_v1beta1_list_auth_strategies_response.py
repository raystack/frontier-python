...
class TestV1beta1ListAuthStrategiesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListAuthStrategiesResponse:
        """Test V1beta1ListAuthStrategiesResponse
        ...
        if include_optional:
            return V1beta1ListAuthStrategiesResponse(
                strategies = [
                    frontier_api.models.v1beta1_auth_strategy.v1beta1AuthStrategy(
                        name = '', 
                        params = frontier_api.models.params.params(), )
                    ]
            )
        else:
            return V1beta1ListAuthStrategiesResponse(
    ...
    def testV1beta1ListAuthStrategiesResponse(self):
        """Test V1beta1ListAuthStrategiesResponse"""
