...
class TestV1beta1ListBillingTransactionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListBillingTransactionsResponse:
        """Test V1beta1ListBillingTransactionsResponse
        ...
        if include_optional:
            return V1beta1ListBillingTransactionsResponse(
                transactions = [
                    frontier_api.models.v1beta1_billing_transaction.v1beta1BillingTransaction(
                        id = '', 
                        customer_id = '', 
                        source = '', 
                        amount = '', 
    ...
    def testV1beta1ListBillingTransactionsResponse(self):
        """Test V1beta1ListBillingTransactionsResponse"""
