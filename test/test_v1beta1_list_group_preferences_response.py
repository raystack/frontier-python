...
class TestV1beta1ListGroupPreferencesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListGroupPreferencesResponse:
        """Test V1beta1ListGroupPreferencesResponse
    ...
    def testV1beta1ListGroupPreferencesResponse(self):
        """Test V1beta1ListGroupPreferencesResponse"""
