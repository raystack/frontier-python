...
class TestV1beta1ListGroupUsersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListGroupUsersResponse:
        """Test V1beta1ListGroupUsersResponse
        ...
        if include_optional:
            return V1beta1ListGroupUsersResponse(
                ...
                role_pairs = [
                    frontier_api.models.v1beta1_list_group_users_response_role_pair.v1beta1ListGroupUsersResponseRolePair(
                        user_id = '', 
                        roles = [
    ...
    def testV1beta1ListGroupUsersResponse(self):
        """Test V1beta1ListGroupUsersResponse"""
