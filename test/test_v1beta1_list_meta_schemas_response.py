...
class TestV1beta1ListMetaSchemasResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListMetaSchemasResponse:
        """Test V1beta1ListMetaSchemasResponse
        ...
        if include_optional:
            return V1beta1ListMetaSchemasResponse(
                metaschemas = [
                    frontier_api.models.v1beta1_meta_schema.v1beta1MetaSchema(
    ...
    def testV1beta1ListMetaSchemasResponse(self):
        """Test V1beta1ListMetaSchemasResponse"""
