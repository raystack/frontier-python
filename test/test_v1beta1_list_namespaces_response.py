...
class TestV1beta1ListNamespacesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListNamespacesResponse:
        """Test V1beta1ListNamespacesResponse
        ...
        if include_optional:
            return V1beta1ListNamespacesResponse(
                namespaces = [
                    frontier_api.models.v1beta1_namespace.v1beta1Namespace(
                        id = '', 
                        name = '', 
    ...
    def testV1beta1ListNamespacesResponse(self):
        """Test V1beta1ListNamespacesResponse"""
