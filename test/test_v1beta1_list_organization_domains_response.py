...
class TestV1beta1ListOrganizationDomainsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListOrganizationDomainsResponse:
        """Test V1beta1ListOrganizationDomainsResponse
        ...
        if include_optional:
            return V1beta1ListOrganizationDomainsResponse(
                domains = [
                    frontier_api.models.v1beta1_domain.v1beta1Domain(
    ...
    def testV1beta1ListOrganizationDomainsResponse(self):
        """Test V1beta1ListOrganizationDomainsResponse"""
