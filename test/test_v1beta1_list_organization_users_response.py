...
class TestV1beta1ListOrganizationUsersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListOrganizationUsersResponse:
        """Test V1beta1ListOrganizationUsersResponse
        ...
        if include_optional:
            return V1beta1ListOrganizationUsersResponse(
                ...
                role_pairs = [
                    frontier_api.models.v1beta1_list_organization_users_response_role_pair.v1beta1ListOrganizationUsersResponseRolePair(
                        user_id = '', 
                        roles = [
    ...
    def testV1beta1ListOrganizationUsersResponse(self):
        """Test V1beta1ListOrganizationUsersResponse"""
