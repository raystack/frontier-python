...
class TestV1beta1ListPlansResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListPlansResponse:
        """Test V1beta1ListPlansResponse
        ...
        if include_optional:
            return V1beta1ListPlansResponse(
                plans = [
                    frontier_api.models.v1beta1_plan.v1beta1Plan(
                        id = '', 
                        name = '', 
                        title = '', 
                        description = '', 
    ...
    def testV1beta1ListPlansResponse(self):
        """Test V1beta1ListPlansResponse"""
