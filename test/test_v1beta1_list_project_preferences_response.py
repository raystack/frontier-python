...
class TestV1beta1ListProjectPreferencesResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListProjectPreferencesResponse:
        """Test V1beta1ListProjectPreferencesResponse
    ...
    def testV1beta1ListProjectPreferencesResponse(self):
        """Test V1beta1ListProjectPreferencesResponse"""
