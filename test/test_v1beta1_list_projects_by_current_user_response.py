...
class TestV1beta1ListProjectsByCurrentUserResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListProjectsByCurrentUserResponse:
        """Test V1beta1ListProjectsByCurrentUserResponse
        ...
        if include_optional:
            return V1beta1ListProjectsByCurrentUserResponse(
                projects = [
                    frontier_api.models.v1beta1_project.v1beta1Project(
                        id = '', 
                        name = '', 
                        title = '', 
                        org_id = '', 
    ...
    def testV1beta1ListProjectsByCurrentUserResponse(self):
        """Test V1beta1ListProjectsByCurrentUserResponse"""
