...
class TestV1beta1ListProjectsByUserResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListProjectsByUserResponse:
        """Test V1beta1ListProjectsByUserResponse
    ...
    def testV1beta1ListProjectsByUserResponse(self):
        """Test V1beta1ListProjectsByUserResponse"""
