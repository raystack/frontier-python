...
class TestV1beta1ListRelationsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListRelationsResponse:
        """Test V1beta1ListRelationsResponse
        ...
        if include_optional:
            return V1beta1ListRelationsResponse(
                relations = [
                    frontier_api.models.v1beta1_relation.v1beta1Relation(
                        id = '', 
    ...
    def testV1beta1ListRelationsResponse(self):
        """Test V1beta1ListRelationsResponse"""
