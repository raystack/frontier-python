...
class TestV1beta1ListServiceUsersResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListServiceUsersResponse:
        """Test V1beta1ListServiceUsersResponse
    ...
    def testV1beta1ListServiceUsersResponse(self):
        """Test V1beta1ListServiceUsersResponse"""
