...
class TestV1beta1ListSubscriptionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1ListSubscriptionsResponse:
        """Test V1beta1ListSubscriptionsResponse
        ...
        if include_optional:
            return V1beta1ListSubscriptionsResponse(
                subscriptions = [
                    frontier_api.models.v1beta1_subscription.v1beta1Subscription(
                        id = '', 
                        customer_id = '', 
                        provider_id = '', 
                        plan_id = '', 
    ...
    def testV1beta1ListSubscriptionsResponse(self):
        """Test V1beta1ListSubscriptionsResponse"""
