...
class TestV1beta1UpdatePermissionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1UpdatePermissionResponse:
        """Test V1beta1UpdatePermissionResponse
    ...
    def testV1beta1UpdatePermissionResponse(self):
        """Test V1beta1UpdatePermissionResponse"""
