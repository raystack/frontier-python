...
class TestV1beta1UpdateSubscriptionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1beta1UpdateSubscriptionResponse:
        """Test V1beta1UpdateSubscriptionResponse
    ...
    def testV1beta1UpdateSubscriptionResponse(self):
        """Test V1beta1UpdateSubscriptionResponse"""
